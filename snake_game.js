...
function mainLoop()
{
    ...
    {
	var hookEle = document.getElementById(HTML_HOOK);
	hookEle.innerHTML += '<form action="score.php" method="post"><input type="hidden" name="score" value="'+gameObj.score+'"><input type="submit" value="Submit Score"></form>';
	display();
